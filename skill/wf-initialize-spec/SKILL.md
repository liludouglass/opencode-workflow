---
name: wf-initialize-spec
description: Initialize a new spec folder structure with date prefix and planning directories
---
...
1. Check `.opencode/product/roadmap.md` to find the next feature in the roadmap.
...
After initialization, proceed with requirements research using `/skill wf-research-spec`.
