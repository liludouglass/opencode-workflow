---
name: wf-research-spec
description: Research and gather requirements through clarifying questions, visual analysis, and reusability checks
---
...
1. **Read Product Mission**: Load `.opencode/product/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `.opencode/product/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `.opencode/product/tech-stack.md` to understand:
...
After requirements research, proceed with specification writing using `/skill wf-write-spec`.
